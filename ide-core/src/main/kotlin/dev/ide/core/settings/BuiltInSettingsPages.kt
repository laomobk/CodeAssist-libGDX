...
object BuiltInSettingsPages {
    ...
    private val editor = page(EDITOR, "Editor", "code", 10) {
        listOf(
            ...
            SettingControl.Toggle("showEditorTabs", "Show tab bar", "Show open files in a tab strip above the editor", default = d.showEditorTabs),
            SettingControl.Toggle("showBreadcrumbBar", "Show navigation bar", "Show the current module, type, and member above the editor", default = d.showBreadcrumbBar),
            SettingControl.Toggle("showLineNumbers", "Show line numbers", "Show line numbers in the editor gutter", default = d.showLineNumbers),
            SettingControl.IntSlider(
                "gutterWidthDp", "Gutter width", "Preferred gutter width; expands only when needed to fit line numbers",
                default = d.gutterWidthDp, min = IdeSettings.MIN_GUTTER_WIDTH_DP,
                max = IdeSettings.MAX_GUTTER_WIDTH_DP, step = 2, unit = "dp",
            ),
