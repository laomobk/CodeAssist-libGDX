...
private val CONTROL_TITLE: Map<String, StringResource> = mapOf(
    ...
    "editor.showEditorTabs" to Res.string.set_editor_tabs,
    "editor.showBreadcrumbBar" to Res.string.set_editor_breadcrumb,
    "editor.showLineNumbers" to Res.string.set_editor_line_numbers,
    "editor.gutterWidthDp" to Res.string.set_editor_gutter_width,
...
private val CONTROL_DESC: Map<String, StringResource> = mapOf(
    ...
    "editor.showEditorTabs" to Res.string.set_editor_tabs_desc,
    "editor.showBreadcrumbBar" to Res.string.set_editor_breadcrumb_desc,
    "editor.showLineNumbers" to Res.string.set_editor_line_numbers_desc,
    "editor.gutterWidthDp" to Res.string.set_editor_gutter_width_desc,
